...
.controller('DiagnosticUsersController', function($state, $rootScope, $scope, $filter, $location, $timeout, flash,  UsersFactory, SweetAlert, RemoveUser, BranchesEdit){
   ...
   $scope.myusers = function() {
    ...
    if($state.current.name === 'my_diagnostic_users') {
