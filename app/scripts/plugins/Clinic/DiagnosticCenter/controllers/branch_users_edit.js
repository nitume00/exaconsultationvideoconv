...
.controller('DiagnosticUsersEditController', function($state, $rootScope, $scope, $filter, $location, $timeout, flash,  CountriesFactory, UsersFactory,UsersEdit, PermissionsFactory){
    ...
    */
    ...
    params.filter = '{"include":{"0":"branch","1":"user.user_profile","2":"user.attachment","3":"user.user_profile.city","4":"user.user_profile.country"}}';
    $scope.userEdit = function() {
        UsersEdit.get(params, function(response) {
            ...
            $scope.userData.country_id = response.data.user.user_profile.country.id;   
        });
    };
    $scope.userEdit();
