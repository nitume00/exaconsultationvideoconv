...
/**
 * @ngdoc function
 * @name abs.controller:CashWithdrawalsController
 * @description
...
angular.module('abs.Common.Withdrawal')
    .controller('CashWithdrawalsController', ['$rootScope', '$scope', 'cashWithdrawals', 'moneyTransferAccount', 'flash', '$filter', '$state', 'UserMeFactory','$location', 'myUserFactory', function($rootScope, $scope, cashWithdrawals, moneyTransferAccount, flash, $filter, $state, UserMeFactory, $location, myUserFactory) {
        ...
        /*jshint -W117 */
        $rootScope.pageTitle = $rootScope.settings.SITE_NAME + ' | ' + $filter("translate")("Cash Withdrawals");
        ...
        $scope.index = function() {
            ...
            cashparams.filter = '{"include":{"0":"money_transfer_account","1":"withdrawal_status"}}';
